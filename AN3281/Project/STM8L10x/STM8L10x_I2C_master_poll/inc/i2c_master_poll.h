...
#ifdef _COSMIC_
@far @interrupt void I2CInterruptHandler (void);
#else
void I2CInterruptHandler (void) interrupt 29;
#endif
#ifdef _COSMIC_
@far @interrupt void TIM4InterruptHandler (void);
#else
void TIM4InterruptHandler (void) interrupt 25;
#endif
