...
{ 
  ...
  /* main loop */
	while (!I2C_WriteRegister(0x51,SEV_BIT_ADDRESS,STOP,0x05, dummy_Tab));
	while(1) 
	{

		while (!I2C_WriteRegister(0x51,SEV_BIT_ADDRESS,NOSTOP,0x01, dummy_Tab));
		while (!I2C_ReadRegister(0x51,SEV_BIT_ADDRESS,NOSTOP,0x03, dummy));
		
		while (!I2C_WriteRegister(0x51,SEV_BIT_ADDRESS,NOSTOP,0x01, dummy_Tab));
		while (!I2C_ReadRegister(0x51,SEV_BIT_ADDRESS,NOSTOP,0x02, dummy));
		
		while (!I2C_WriteRegister(0x51,SEV_BIT_ADDRESS,NOSTOP,0x01, dummy_Tab));
		while (!I2C_ReadRegister(0x51,SEV_BIT_ADDRESS,NOSTOP,0x01, dummy));
	}
